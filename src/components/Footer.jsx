...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-winter dark:bg-sunset  pb-10 pt-20  lg:pb-20 lg:pt-[120px]">
        <div className="container mx-auto border-t border-l-black pt-4 ">
              ...
              <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div className="mb-10 w-full">
                  ...
                  <div className="mb-6 flex items-center">
                    <a className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4">
                      <svg
                        width="8"
                        height="16"
                        viewBox="0 0 8 16"
    ...
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="mb-10 w-full">
          ...
          <ul className="space-y-3 text-sm  *:cursor-pointer">{children}</ul>
        </div>
      </div>
    </>
  );
