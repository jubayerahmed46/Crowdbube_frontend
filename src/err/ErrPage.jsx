    ...
    <>
      ...
      <main className="grid min-h-full place-items-center dark:bg-sunset bg-winter px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="mt-4 text-balance text-5xl font-semibold dark:text-neutral-200 tracking-tight  sm:text-7xl">
            Page not found
          </h1>
          <p className="mt-6 text-pretty text-lg font-medium  dark:text-neutral-200 sm:text-xl/8">
