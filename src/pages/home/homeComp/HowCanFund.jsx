  ...
  return (
    <div className="flex flex-col md:flex-row gap-10 items-center md:items-center mt-14  bg-gray-600/5 rounded-md px-4 py-14">
      ...
      <div className="flex-1 w-full">
        ...
        <p className=" mb-4 text-base leading-relaxed dark:text-dark/80">
          ...
          raise money for their specific needs. Fundraising for personal reasons
          is not something that everyone should do for fun. As it involves a
          large number of people, it is essential that the cause must be
          significant enough for crowdfunding purposes.
        </p>
        <p className="dark:text-dark/80 text-base leading-relaxed">
